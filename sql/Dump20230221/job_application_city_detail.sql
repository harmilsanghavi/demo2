...
CREATE TABLE `city_detail` (
  ...
  CONSTRAINT `state_id` FOREIGN KEY (`state_id`) REFERENCES `state_detail` (`id`)
...
INSERT INTO `city_detail` VALUES (4,1,'ahmdedabad'),(5,1,'surat'),(6,1,'rajkot'),(7,2,'jaipur'),(8,2,'udaipur'),(9,3,'mubai');
