...
INSERT INTO `select_master` VALUES (1,'state','state'),(2,'relationship','relationship'),(3,'location','location'),(4,'department','department'),(5,'coursename','coursename'),(6,'technology','technology'),(7,'language','language');
